const translations = {
  fr: {
    ...
    photoCredit: "Photographies : Xavi Olmos · Festival Poetas 2025, La Casa Encendida", inauditMeta: "AVEC ADRIANO GALANTE · 2024–2025", inauditRole: "Création technique, son et image", inauditText: "Une recherche scénique sur le corps, le patrimoine sonore et l’écoute spatiale. Avec Adriano Galante, j’ai développé la relation entre lumière, tubes LED, projection, caméras et dispositifs sonores afin de transformer l’espace en instrument et en archive sensible.", pumaRole: "Conception technique conduite depuis le plateau", pumaText: "J’ai conçu l’implantation des projecteurs et la relation entre son, projection et écrans. J’ai programmé et déclenché les mémoires lumière depuis l’espace scénique, en intégrant la conduite à la dramaturgie et en adaptant la pièce pendant la résidence technique.",
  ...
  nl: {
    ...
    photoCredit: "Fotografie: Xavi Olmos · Festival Poetas 2025, La Casa Encendida", inauditMeta: "MET ADRIANO GALANTE · 2024–2025", inauditRole: "Technische creatie, geluid en beeld", inauditText: "Een podiumonderzoek naar lichaam, klankerfgoed en ruimtelijk luisteren. Samen met Adriano Galante ontwikkelde ik de relatie tussen licht, led-buizen, projectie, camera’s en geluidsapparatuur om de ruimte te veranderen in een instrument en een gevoelig archief.", pumaRole: "Technisch ontwerp bediend vanaf de speelvloer", pumaText: "Ik ontwierp de plaatsing van de armaturen en de relatie tussen geluid, projectie en schermen. Ik programmeerde en triggerde de lichtstanden vanaf de speelvloer, integreerde de bediening in de dramaturgie en paste het werk aan tijdens de technische residentie.",
    ...
    projection: "Projectie", video: "Video", touring: "Tournee", contactLabel: "CONTACT", contactTitle: "Laten we over de ruimte praten voordat we haar belichten.", contactText: "Beschikbaar voor lichtontwerp, assistentie, programmering, aanpassing en bediening tijdens residenties, producties en tournees.", location: "Brussel, België · Internationaal beschikbaar", backSite: "Terug naar de hoofdwebsite", pedagogySite: "Pedagogisch portfolio"
  }
};
